...
void _lcd_Write(unsigned char dataToWrite); //sam dopisalem bo mialem warning compilatora. M.Waszak
void _lcd_OutNibble(unsigned char nibbleToWrite); //sam dopisalem bo mialem warning compilatora. M.Waszak
